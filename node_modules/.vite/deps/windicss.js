...
var variantOrder = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], pseudoClassNames, true), [
  "not-checked",
  "not-disabled",
  "not-first-of-type",
  "not-last-of-type",
...
function generateStates(variantOrder2) {
  ...
  var states = __assign(__assign(__assign(__assign(__assign({}, peseudoClassStates), {
