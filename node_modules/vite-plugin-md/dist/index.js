...
// node_modules/.pnpm/tsup@5.12.6_typescript@4.6.3/node_modules/tsup/assets/cjs_shims.js
var init_cjs_shims = __esm({
  "node_modules/.pnpm/tsup@5.12.6_typescript@4.6.3/node_modules/tsup/assets/cjs_shims.js"() {
  }
});

// node_modules/.pnpm/fp-ts@2.12.0/node_modules/fp-ts/lib/function.js
var require_function = __commonJS({
  "node_modules/.pnpm/fp-ts@2.12.0/node_modules/fp-ts/lib/function.js"(exports) {
    "use strict";
    init_cjs_shims();
...
// node_modules/.pnpm/@vue+compiler-core@3.2.33/node_modules/@vue/compiler-core/dist/compiler-core.esm-bundler.js
...
// node_modules/.pnpm/@vue+compiler-dom@3.2.33/node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js
...
// node_modules/.pnpm/@vue+runtime-dom@3.2.33/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js
...
// node_modules/.pnpm/vue@3.2.33/node_modules/vue/dist/vue.cjs.prod.js
var require_vue_cjs_prod = __commonJS({
  "node_modules/.pnpm/vue@3.2.33/node_modules/vue/dist/vue.cjs.prod.js"(exports) {
    "use strict";
    init_cjs_shims();
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/.pnpm/vue@3.2.33/node_modules/vue/dist/vue.cjs.js
var require_vue_cjs = __commonJS({
  "node_modules/.pnpm/vue@3.2.33/node_modules/vue/dist/vue.cjs.js"(exports) {
    "use strict";
    init_cjs_shims();
    Object.defineProperty(exports, "__esModule", { value: true });
    var compilerDom = (init_compiler_dom_esm_bundler(), __toCommonJS(compiler_dom_esm_bundler_exports));
...
// node_modules/.pnpm/vue@3.2.33/node_modules/vue/index.js
var require_vue = __commonJS({
  "node_modules/.pnpm/vue@3.2.33/node_modules/vue/index.js"(exports, module2) {
    "use strict";
    init_cjs_shims();
    if (process.env.NODE_ENV === "production") {
...
init_cjs_shims();
function applyMarkdownItOptions(payload) {
  payload.options.markdownItSetup(payload.parser);
  return payload;
}

// src/pipeline/composeSfcBlocks.ts
init_cjs_shims();
...
function preprocessHead(frontmatter, options) {
  ...
  const meta2 = head.meta = head.meta || [];
  if (head.title) {
    if (!meta2.find((i) => i.property === "og:title"))
      meta2.push({ property: "og:title", content: head.title });
  }
  if (head.description) {
    if (!meta2.find((i) => i.property === "og:description"))
      meta2.push({ property: "og:description", content: head.description });
    if (!meta2.find((i) => i.name === "description"))
      meta2.push({ name: "description", content: head.description });
  }
  if (head.image) {
    if (!meta2.find((i) => i.property === "og:image"))
      meta2.push({ property: "og:image", content: head.image });
    if (!meta2.find((i) => i.property === "twitter:card"))
      meta2.push({ name: "twitter:card", content: "summary_large_image" });
  }
  const result = {};
...
function resolveOptions(userOptions = {}) {
  ...
  const options = userOptions.frontmatterPreprocess === null ? __spreadValues(__spreadValues({}, defaultOptions), userOptions) : __spreadProps(__spreadValues(__spreadValues({}, defaultOptions), userOptions), {
    frontmatterPreprocess: (frontmatter, options2) => {
      const head = preprocessHead(frontmatter, options2);
      return { head, frontmatter };
    }
  });
  options.wrapperClasses = (0, import_utils.toArray)(options.wrapperClasses).filter((i) => i).join(" ");
  return options;
}
...
function createParser(payload) {
  var _a;
  const parser = new import_markdown_it.default(__spreadValues({
    html: true,
    linkify: true,
    typographer: true
  }, ((_a = payload.options) == null ? void 0 : _a.markdownItOptions) ? payload.options.markdownItOptions : {}));
  parser.linkify.set({ fuzzyLink: false });
  return __spreadProps(__spreadValues({}, payload), { parser });
}

// src/pipeline/composeSfcBlocks.ts
function composeSfcBlocks(id, raw, opts = {}, config = {}) {
  ...
  const builders = options.builders.reduce((acc, b) => {
    const defn = b();
  ...
  const callEventHooks = (stage) => (payload2) => {
    for (const b of builders[stage] || [])
      payload2 = b.handler(payload2, b.options);
    return payload2;
  };
  const result = (0, import_function.pipe)(payload, transformsBefore, callEventHooks("initialize" /* initialize */), extractFrontmatter, frontmatterPreprocess, callEventHooks("metaExtracted" /* metaExtracted */), createParser, loadMarkdownItPlugins, applyMarkdownItOptions, callEventHooks("parser" /* parser */), parseHtml, wrapHtml, escapeCodeTagInterpolation, callEventHooks("parsed" /* parsed */), extractBlocks, callEventHooks("sfcBlocksExtracted" /* sfcBlocksExtracted */), finalize, transformsAfter, callEventHooks("closeout" /* closeout */));
  return result;
}

// src/pipeline/escapeCodeTagInterpolation.ts
init_cjs_shims();
var codeTagRe = /<code(?:.*?language-([!]{0,1})(\w+))?(.*?)>/g;
function escapeCodeTagInterpolation(payload) {
  const { options: { escapeCodeTagInterpolation: escapeCodeTagInterpolation2 }, html, fencedLanguages } = payload;
  ...
  for (const m of match) {
    ...
    if (escapeCodeTagInterpolation2) {
      if (negation !== "!")
  ...
  return __spreadProps(__spreadValues({}, payload), { html: updated, fencedLanguages });
}
...
function extractBlocks(payload) {
  ...
  const hoistedScripts = hoistScripts.scripts;
  ...
  useHead(head)` : "",
    ...
    exposeFrontmatter: options.frontmatter && options.exposeFrontmatter ? `defineExpose({ frontmatter: ${JSON.stringify(frontmatter)} })` : "",
    frontmatter: options.frontmatter && options.exposeFrontmatter ? `export const frontmatter = ${JSON.stringify(frontmatter)}` : "",
    vue3CompositionReturn: options.frontmatter ? "return { frontmatter }" : "",
    vue2DataExport: "export default { data() { return { frontmatter } } }",
    localVariables: Object.entries(frontmatter).reduce((acc, [key, value]) => `${acc}
${isVue2(options) ? "export" : ""} const ${key} = ${JSON.stringify(value)}`, ""),
    routeMeta: Object.keys(routeMeta || {}).length > 0 ? `<route>{ meta: { ${JSON.stringify(routeMeta)} } }</route>
` : ""
  };
  const scriptBlock = isVue2(options) ? wrap("script", [
    ...hoistedScripts,
    ...
    ${blocks.routeMeta}`;
  return __spreadProps(__spreadValues({}, payload), { hoistedScripts, templateBlock, scriptBlock, customBlocks });
}
...
function extractFrontmatter(payload) {
  ...
  const eConfig = [e, ge];
  const excerpt = eConfig.find((i) => i === false) !== void 0 ? false : eConfig.find((i) => typeof i === "function") ? eConfig.find((i) => typeof i === "function") : true;
  const excerpt_separator = excerpt === false ? void 0 : typeof e === "string" ? e : ge || void 0;
  const o = __spreadValues(__spreadProps(__spreadValues({}, payload.options.grayMatterOptions), {
    excerpt
  }), excerpt_separator ? { excerpt_separator } : {});
  const r = (0, import_gray_matter.default)(payload.content, o);
  return __spreadProps(__spreadValues({}, payload), {
    options: __spreadProps(__spreadValues({}, payload.options), {
      grayMatterOptions: o
    }),
    frontmatter: __spreadProps(__spreadValues({}, r.data), { excerpt: ((_b = (_a = r == null ? void 0 : r.data) == null ? void 0 : _a.excerpt) == null ? void 0 : _b.trim()) || ((_c = r == null ? void 0 : r.excerpt) == null ? void 0 : _c.trim()) || void 0 }),
    md: r.content,
    excerpt: r.excerpt || ((_d = r.data) == null ? void 0 : _d.excerpt) || void 0,
    meta: [],
    head: [],
    routeMeta: {}
  });
...
function frontmatterPreprocess(payload) {
  ...
  if (((_a = results.head) == null ? void 0 : _a.meta) && Array.isArray((_b = results.head) == null ? void 0 : _b.meta))
    meta2 = [...meta2, ...results.head.meta];
  head = __spreadValues(__spreadValues({}, head), results.head);
  routeMeta = __spreadValues(__spreadValues({}, routeMeta), results.routeMeta);
  return __spreadProps(__spreadValues(__spreadValues({}, payload), results), { head, meta: meta2, routeMeta });
}

// src/pipeline/loadMarkdownItPlugins.ts
init_cjs_shims();
var import_utils5 = require("@antfu/utils");
function loadMarkdownItPlugins(payload) {
  payload.options.markdownItUses.forEach((e) => {
    const [plugin2, options] = (0, import_utils5.toArray)(e);
    payload.parser.use(plugin2, options);
  });
  return payload;
}
...
function parseHtml(payload) {
  ...
  return __spreadProps(__spreadValues({}, payload), { html, fencedLanguages: /* @__PURE__ */ new Set() });
}

// src/pipeline/transformsBefore.ts
init_cjs_shims();
function transformsBefore(payload) {
  const { options: { transforms: { before } } } = payload;
  return before ? __spreadProps(__spreadValues({}, payload), { content: before(payload.content, payload.fileName) }) : payload;
}

// src/pipeline/transformsAfter.ts
init_cjs_shims();
function transformsAfter(payload) {
  const { options: { transforms: { after } } } = payload;
  return after ? __spreadProps(__spreadValues({}, payload), { content: after(payload.component, payload.fileName) }) : payload;
}

// src/pipeline/wrapHtml.ts
init_cjs_shims();
function wrapHtml(payload) {
...
// src/builders/link/index.ts
init_cjs_shims();

// src/builders/link/link.ts
init_cjs_shims();
var import_path = require("path");
var import_function2 = __toESM(require_function());
var import_vite2 = require("vite");

// src/builders/createBuilder.ts
init_cjs_shims();
function createBuilder(name, lifecycle) {
  return {
    options: () => {
      return {
        initializer: (initializer) => {
          return {
            handler: (handler) => {
              return {
                meta: (meta2) => {
                  const registration = __spreadProps(__spreadValues({}, meta2), {
                    name,
                    lifecycle,
                    handler,
                    initializer
                  });
                  return (options = {}) => () => __spreadProps(__spreadValues({}, registration), { options });
                }
              };
            }
          };
...
var plugin = (o) => (md) => {
  if (!o || !o.transform) {
    ...
    const base = (0, import_vite.normalizePath)((0, import_node_path.join)(o.base || "/", (0, import_node_path.dirname)(o.file)));
    ...
    md.renderer.rules.link_close = function(tokens, idx, options, _env, self2) {
      const close = tokens[idx];
      const priors = tokens.slice(0, idx).reverse();
      let open;
      let openIdx = -1;
      priors.forEach((t, idx2) => {
...
function isExternalLink(meta2) {
  return !!(meta2.href && staticRuleLookup.externalLinkClass.test(meta2.href));
}
function isInternalLink(meta2) {
  return !!(meta2.href && staticRuleLookup.internalLinkClass.test(meta2.href));
}
function strTransform(transformer, meta2) {
  if (!transformer)
    return void 0;
  else if (typeof transformer === "function")
    return transformer(meta2);
  else
    return transformer;
}
...
var cleanupAndCloseOut = (c) => (lnk) => {
  if (isInternalLink(lnk)) {
    ...
    if (isInternalLink(lnk))
      lnk.href = (0, import_vite2.normalizePath)((0, import_path.join)(lnk._base.replace(removal, ""), lnk.href));
...
var link = createBuilder("link", "parser").options().initializer().handler((p2, o) => {
  const { fileName, viteConfig: { base } } = p2;
  ...
  const transform2 = (event) => {
    return (0, import_function2.pipe)(event, classes, targetting, cleanup, postProcessing);
  };
  p2.parser.use(md_link_default({ file: fileName, transform: transform2, base }));
  return p2;
}).meta({
...
// src/builders/meta/index.ts
init_cjs_shims();

// src/builders/meta/meta.ts
init_cjs_shims();
function addMetaTag(k, v) {
  return {
    name: `twitter:${k}`,
    property: `og:${k}`,
    itemprop: k,
...
var meta = createBuilder("meta", "metaExtracted").options().initializer().handler((p2, o) => {
  let { frontmatter, meta: meta2, head, routeMeta } = p2;
  const c = __spreadValues({
  ...
  for (const k of Object.keys(c.defaults)) {
    if (typeof c.defaults[k] === "function")
      c.defaults[k] = c.defaults[k](frontmatter);
  }
  frontmatter = [...Object.keys(frontmatter), ...Object.keys(c.defaults)].reduce((acc, p3) => __spreadProps(__spreadValues({}, acc), { [p3]: frontmatter[p3] || c.defaults[p3] }), {});
  head = __spreadValues(__spreadValues({}, head), c.headProps.reduce((acc, p3) => __spreadProps(__spreadValues({}, acc), { [p3]: frontmatter[p3] }), {}));
  meta2 = [
    ...meta2,
    ...c.metaProps.reduce((acc, p3) => frontmatter[p3] || c.defaults[p3] ? [...acc, addMetaTag(p3, frontmatter[p3])] : acc, [])
  ];
  routeMeta = __spreadValues(__spreadValues({}, routeMeta), c.routeProps.reduce((acc, p3) => __spreadProps(__spreadValues({}, acc), { [p3]: frontmatter[p3] }), {}));
