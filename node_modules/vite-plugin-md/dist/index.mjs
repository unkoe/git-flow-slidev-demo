...
// node_modules/.pnpm/tsup@5.12.6_typescript@4.6.3/node_modules/tsup/assets/esm_shims.js
...
var init_runtime_dom_esm_bundler = __esm({
  "node_modules/.pnpm/@vue+runtime-dom@3.2.33/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js"() {
    init_esm_shims();
    __reExport(runtime_dom_esm_bundler_exports, runtime_core_star);
    init_shared_esm_bundler();
...
var require_vue = __commonJS({
  "node_modules/.pnpm/vue@3.2.33/node_modules/vue/index.js"(exports, module) {
    "use strict";
    init_esm_shims();
    if (process.env.NODE_ENV === "production") {
...
function loadMarkdownItPlugins(payload) {
  payload.options.markdownItUses.forEach((e) => {
    const [plugin2, options] = toArray2(e);
...
var cleanupAndCloseOut = (c) => (lnk) => {
  if (isInternalLink(lnk)) {
    ...
    if (isInternalLink(lnk))
      lnk.href = normalizePath2(join2(lnk._base.replace(removal, ""), lnk.href));
