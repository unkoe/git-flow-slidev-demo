...
function cmdExists(cmd) {
  try {
    execSync(os$1.platform() === "win32" ? `cmd /c "(help ${cmd} > nul || exit 0) && where ${cmd} > nul 2> nul"` : `command -v ${cmd}`);
    return true;
  } catch {
    return false;
  }
...
async function getConfig() {
  ...
  if (!config) {
    ...
    let packageManager = "";
    if (result)
      packageManager = (_a = JSON.parse(fs$3.readFileSync(result, "utf8")).packageManager) != null ? _a : "";
    ...
    else if (!fs$3.existsSync(rcPath))
      config = defaultConfig;
    else
      config = Object.assign({}, defaultConfig, ini.parse(fs$3.readFileSync(rcPath, "utf-8")));
  }
  return config;
}
...
var readline$1 = require$$0$5;
var _require$9 = util$1;
var action$2 = _require$9.action;
var EventEmitter$1 = require$$2;
var _require2$9 = src;
...
async function detect({ autoInstall, cwd }) {
  ...
  if (packageJsonPath && fs$3.existsSync(packageJsonPath)) {
    try {
      const pkg = JSON.parse(fs$3.readFileSync(packageJsonPath, "utf8"));
